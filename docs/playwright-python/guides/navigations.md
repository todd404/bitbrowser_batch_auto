...
Clicking an element could trigger multiple navigations. In these cases, it is recommended to explicitly [page.wait_for_url()](https://playwright.dev/python/docs/api/class-page#page-wait-for-url) to a specific url.
